...
SN1=MPC;
% Adding 1 phase PVs
SN1.a=openPV([],300,700,SN1.a); % in KW
SN1.b=openPV([],300,700,SN1.b); % in KW
SN1.c=openPV([],300,700,SN1.c); % in KW
% Adding 3 phase PVs
SN1=open3PV([],300,900,SN1); % in KW
% Adding EVs
SN1.a=openEV([],180,300,SN1.a); % in KW
SN1.b=openEV([],180,300,SN1.b); % in KW
SN1.c=openEV([],180,300,SN1.c); % in KW
% Adding 3 phase EVs
SN1=open3EV([],300,540,SN1); % in KW
for i=1:T
