...
SN1=MPC;
% Adding 1 phase PVs
SN1.a=openPV([],300,60,SN1.a); % in KW
SN1.b=openPV([],300,600,SN1.b); % in KW
SN1.c=openPV([],300,600,SN1.c); % in KW
% Adding 3 phase PVs
SN1=open3PV([],360,720,SN1); % in KW
% Adding EVs
SN1.a=openEV([8 19],60,180,SN1.a); % in KW
SN1.b=openEV([5 21],60,180,SN1.b); % in KW
SN1.c=openEV([2 11 30],60,180,SN1.c); % in KW
% Adding 3 phase EVs
SN1=open3EV([10 15 20 25],180,540,SN1); % in KW
for i=1:T
