...
SN1=MPC;
% Adding 1 phase PVs
SN1.a=openPV([10 20],50,100,SN1.a); % in KW
SN1.b=openPV([18 33],50,100,SN1.b); % in KW
SN1.c=openPV([3 13 23],50,100,SN1.c); % in KW
% Adding 3 phase PVs
SN1=open3PV([7 17 27 33],90,150,SN1); % in KW
% Adding EVs
SN1.a=openEV([8 19],10,30,SN1.a); % in KW
SN1.b=openEV([5 21],10,30,SN1.b); % in KW
SN1.c=openEV([2 11 30],10,30,SN1.c); % in KW
% Adding 3 phase EVs
SN1=open3EV([10 15 20 25],30,90,SN1); % in KW
for i=1:T
