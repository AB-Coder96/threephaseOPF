...
%% Adding EVs
SN1.a=openEV([10 30],1,SN1.a,SN1.qlim);
SN1.b=openEV([9],1,SN1.b,SN1.qlim);
SN1.c=openEV([6],1,SN1.c,SN1.qlim);
%% Adding 3 phase EVs
SN1=open3ev([6 7 20 33],3,SN1,qlim);
%% scaling unbalance
...
%% Adding EVs
SN2.a=openEV([10 30],1,SN2.a,SN2.qlim);
SN2.b=openEV([9],1,SN2.b,SN2.qlim);
SN2.c=openEV([6],1,SN2.c,SN2.qlim);
%% Adding 3 phase EVs
SN2=open3ev([6 7 20 33],3,SN2,qlim);
%% scaling unbalance
...
%% Adding EVs
SN3.a=openEV([10 30],1,SN3.a,SN1.qlim);
SN3.b=openEV([9],1,SN3.b,SN1.qlim);
SN3.c=openEV([6],1,SN3.c,SN1.qlim);
%% Adding 3 phase EVs
SN3=open3ev([6 7 20 33],3,SN3,qlim);
%% modyfing PV limits
%MPC=pvlimitp(MPC,-3,3);
%SN3=pvlimitq(SN3,-4,+4);
%% scaling unbalance
