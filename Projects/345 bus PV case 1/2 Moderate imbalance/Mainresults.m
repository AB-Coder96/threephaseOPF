...
figure1=createbar3([results3phaseUB.bus.p.a(:,1) results3phaseUB.bus.p.b(:,1) results3phaseUB.bus.p.c(:,1)],...
     ...
     [results3phaseUB.bus.s.a(:,2) results3phaseUB.bus.s.b(:,2) results3phaseUB.bus.s.c(:,2)],'P, Q , and S: Medium Imbalance');
...
figure2=createfigure_4(abs(Ymatrix),'VUFs comparison: Medium Imbalance','ACOPF-PV','ILACOPF-PV','VUF Standard','IBLACOPF-PV');
...
figure3=createfigure_3r(YMatrix2,'3 Phase Voltage Magnitudes: Medium Imbalance','Magnitude (p.u)','ACOPF-PV (a)','ACOPF-PV (b)','ACOPF-PV (c)','ILACOPF-PV (a)','ILACOPF-PV (b)','ILACOPF-PV (c)','IBLACOPF-PV (a)','IBLACOPF-PV (b)','IBLACOPF-PV (c)');
...
[figure4,legend4]=createfigure_3r(YMatrix2,'3 Phase Voltage Angles: Medium Imbalance','angles (Degree)','ACOPF-PV (a)','ACOPF-PV (b)','ACOPF-PV (c)','ILACOPF-PV (a)','ILACOPF-PV (b)','ILACOPF-PV (c)','IBLACOPF-PV (a)','IBLACOPF-PV (b)','IBLACOPF-PV (c)');
