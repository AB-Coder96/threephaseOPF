...
SN1=MPC;
% Adding 1 phase PVs
SN1.a=openPV([],400,700,SN1.a); % in KW
SN1.b=openPV([],400,700,SN1.b); % in KW
SN1.c=openPV([],400,700,SN1.c); % in KW
% Adding 3 phase PVs
SN1=open3PV([],540,900,SN1); % in KW
% Adding EVs
SN1.a=openEV([],60,180,SN1.a); % in KW
SN1.b=openEV([],60,180,SN1.b); % in KW
SN1.c=openEV([],60,180,SN1.c); % in KW
% Adding 3 phase EVs
SN1=open3EV([],180,540,SN1); % in KW
for i=1:T
