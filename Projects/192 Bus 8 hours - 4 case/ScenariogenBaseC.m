...
SN1=MPC;
% Adding 1 phase PVs
SN1.a=openPV([10 30 60 90 120 140],0,100,SN1.a); % in KW
SN1.b=openPV([15 25 65 85 105 143 40],0,100,SN1.b); % in KW
SN1.c=openPV([19 28 69 5  3   130 100],0,100,SN1.c); % in KW
% Adding 3 phase PVs
SN1=open3PV([7 17 27 33 55 82 94 126],0,300,SN1); % in KW
% Adding EVs
SN1.a=openEV([8 19 39 61 99 139],0,40,SN1.a); % in KW
SN1.b=openEV([10 21 42 52 78 95],0,40,SN1.b); % in KW
SN1.c=openEV([2 12 31 84 111 119],0,40,SN1.c); % in KW
% Adding 3 phase EVs
SN1=open3EV([10 15 20 25 66 88 122],0,120,SN1); % in KW
for i=1:T
