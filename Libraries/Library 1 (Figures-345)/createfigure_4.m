...
set(plot1(1),'DisplayName',leg1,'LineWidth',1,'Color','b');
set(plot1(2),'DisplayName',leg2,'LineWidth',1,'Color','r');
set(plot1(3),'DisplayName',leg3,'LineWidth',1,'Color','k');
set(plot1(4),'DisplayName',leg4,'LineWidth',1,'Color',[0 0.5 0]);
...
% Create textarrow
annotation(figure1,'textarrow',[0.211266294227188 0.211682184978274],...
    [0.289864346967848 0.207925958342256],'String',{'VUF limit'},...
    'FontName','Georgia');
xlim([0 192])