...
bar2=bar(Ymatrix2);
set(bar2,'barwidth',1)
set(bar2(1),'DisplayName','IBLACOPF-PVEV (a)','FaceColor','b')
set(bar2(2),'DisplayName','IBLACOPF-PVEV (b)','FaceColor','r')
set(bar2(3),'DisplayName','IBLACOPF-PVEV (c)','FaceColor',g)
ylabel('P(kW)')
xlabel('Bus numbers')
...
legend1 = legend('show');
set(legend1,'NumColumns',1,'FontSize',9,'location','northwest');