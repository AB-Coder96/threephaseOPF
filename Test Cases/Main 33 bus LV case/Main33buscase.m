...
MPC.b.bus(:,3)=1*MPC.a.bus(:,4);
MPC.c.bus(:,3)=1*MPC.b.bus(:,3);
MPC.a.bus(:,4)=1*MPC.b.bus(:,4);
MPC.b.bus(:,4)=1*MPC.c.bus(:,3);
MPC.c.bus(:,4)=1*MPC.c.bus(:,4);
%% R X Values
MPC.a.branch(:,3)=1*MPC.a.branch(:,3);
MPC.a.branch(:,4)=1*MPC.a.branch(:,4);
MPC.b.branch(:,3)=1*MPC.b.branch(:,3);
MPC.b.branch(:,4)=1*MPC.b.branch(:,4);
MPC.c.branch(:,3)=1*MPC.c.branch(:,3);
MPC.c.branch(:,4)=1*MPC.c.branch(:,4);
%% preprocessing
MPC.a.gen(:,11:end)=[];
MPC.b.gen(:,11:end)=[];
MPC.c.gen(:,11:end)=[];
