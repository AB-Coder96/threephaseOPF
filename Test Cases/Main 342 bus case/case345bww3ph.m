%% IEEE 345 test case
function mpc = case345bww3ph
%CASE345  Power flow data for 345 bus distribution system 
clc
clear
...
mpc.baseMVA = 50;
%% Loading data
Bus=readtable('Loads secondary.csv')
Lines=readtable('D:\imbalance aleviation strategies\Test Case 345 IEEE\Lines secondary.csv');
transformers=readtable('D:\imbalance aleviation strategies\Test Case 345 IEEE\Transformers secondary.csv')
%% bus data
%	bus_i	type	Pd	Qd	Gs	Bs	area	Vm	Va	baseKV	zone	Vmax	Vmin
mpc.bus = [  %% (Pd and Qd are specified in kW & kVAr here, converted to MW & MVAr below)
	1	3	0	0	0	0	1	1	0	12.66	1	1	1;
	2	1	100	60	0	0	1	1	0	18.66	1	1.1	0.9;
